from app.Calculator import get_addition, get_subtraction, get_multiplication, get_division
...
class calculator():
    ...
    from app.History import add_calculation, clear_history, get_history,undo_last
    ...
    while True:
            ...
            # Process the input as a calculation.
                ...
                if operation == "add":
                    result = get_addition(num1, num2)
                    print(f"Result: {result}")
                elif operation == "subtract":
                    result = get_subtraction(num1, num2)
                    print(result)
                elif operation == "multiply":
                    result = get_multiplication(num1, num2)
                    print(result)
